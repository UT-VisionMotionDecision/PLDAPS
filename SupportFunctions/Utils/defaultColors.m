...
if p.defaultParameters.display.useOverlay == 1 %TODO make this separate from useDatapixx %(p.defaultParameters.datapixx.use && p.defaultParameters.display.useOverlay)
