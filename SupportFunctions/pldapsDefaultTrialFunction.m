...
p.trial.timing.flipTimes(:,p.trial.iFrame) = callScreenFlip(p.trial.display.ptr,0);
...
function f = callScreenFlip(ptr,when)
f = zeros(5,1);
[f(1),f(2),f(3),f(4),f(5)] = Screen('Flip', ptr,when);
end